...
from pv26.dataset.loading.sample_types import AugmentSpec, Pv26Sample
from pv26.eval.detection import (
    compute_map50,
    cxcywh_to_xyxy,
...
from pv26.training.runtime import (
    format_loss_line,
    resolve_device,
    seed_everything,
)
...
def main() -> int:
    ...
    if args.arch == "stub":
        ...
        criterion = PV26Criterion(
            ...
            det_loss_adapter=UltralyticsE2EDetLossAdapter(model.det_model),
        ).to(device)
    if device.type == "cuda":
