...
class PV26LoaderTests(unittest.TestCase):
    def test_loader_returns_sample_contract_for_aihub_and_bdd_sources(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(tuple(bdd_sample["det_targets"]["boxes_xyxy"].shape), (3, 4))
            self.assertEqual(bdd_sample["valid_mask"]["tl_attr"].tolist(), [False, False, False])
            self.assertEqual(bdd_sample["tl_attr_targets"]["collapse_reason"][1], "bdd_det_only_source")
