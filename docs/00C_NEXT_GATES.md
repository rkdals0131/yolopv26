...
- partial weak-positive only. broader-val512 best stop-line F1은 multi-instance fragment-union CSV replay 기준 `0.5040`이고, opt-in evaluator/postprocess로 재현된 fragment-union 기준은 `0.4948`이다. 둘 다 목표 미달이다.
