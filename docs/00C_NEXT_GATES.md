...
- Learned dense fragment-to-center offset/extent head is also closed. Exact val128 best objective was only `0.5499257237`, and stop-line F1 collapsed to epoch1/2 `0.0267 / 0.0519` with skipped steps `0`. This is valid negative evidence, not a runtime failure; do not broaden or repeat as an aux-weight/top-k/min-score sweep.
