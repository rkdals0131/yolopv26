...
후속 wave에서는 `tools/od_bootstrap/build/contracts.py`를 추가해
`ImageListEntryPayload`, `RunManifestPayload`, `TeacherJobManifestPayload`, `TeacherPredictionRow`를 shared typed surface로 승격했고,
