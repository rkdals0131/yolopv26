...
- `source/`는 경계 정리
- `run_pv26_train.py`는 orchestration 분해

그 다음이

- 공용 IO/path helper 정리
- manifest row typing
- `check_env.py` / `teacher/ultralytics_runner.py` 정리
...
- 가장 효과 큰 다음 타깃은 `tools/od_bootstrap/source/`다.
- 그다음은 `tools/run_pv26_train.py` 분해다.
