...
- 남은 stop-line 방향은 새 query row, endpoint-delta channel, local score window, pairwise component split이 아니라, train-time representation과 readout이 직접 맞는 stronger geometry contract를 찾는 것이다.
