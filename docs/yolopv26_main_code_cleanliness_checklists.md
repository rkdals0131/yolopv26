...
- [x] `tools/od_bootstrap/build/debug_vis.py`, `teacher_dataset.py`, `exhaustive_od.py`, `final_dataset.py`, `sweep.py`에서 JSON manifest row를 `dict[str, Any]` 중심으로 느슨하게 돌리는 구조를 줄인다.
