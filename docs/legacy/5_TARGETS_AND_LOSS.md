...
- sample/transform contract 원문은 [legacy/4A_SAMPLE_AND_TRANSFORM_CONTRACT.md](4A_SAMPLE_AND_TRANSFORM_CONTRACT.md)를 기준으로 한다.
...
| `stage_4_lane_family_finetune` | 4 | 0.0 | 2e-4 | lane-family positive-only sampler / lane-family heads only |
