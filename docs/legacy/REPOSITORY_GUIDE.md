...
> 2026-09-21 개편 전 문서 보관본이다. 현재 목표와 설계는 [PRD](../0_PRD.md)와 [현재 상태](../00A_CURRENT_STATUS.md)를 따른다.
...
- AIHUB와 BDD100K 원본 폴더 구조는 [docs/legacy/3A_RAW_DATASET_LAYOUTS.md](3A_RAW_DATASET_LAYOUTS.md)를 기준으로 맞춘다.
...
- [docs/](..): 번호가 붙은 설계/상태 문서
- [test/](../../test): 테스트 코드

## 참고 문서

- [docs/0_PRD.md](0_PRD.md): 저장소 목표와 전체 범위
- [docs/00A_CURRENT_STATUS.md](00A_CURRENT_STATUS.md): 현재 상태 snapshot
- [docs/00C_NEXT_GATES.md](00C_NEXT_GATES.md): 다음 gate와 금지사항
- [docs/history/README.md](../history/README.md): 실패/수정/결과 오답노트 index
- [docs/legacy/3_DATA_AND_STANDARDIZATION.md](3_DATA_AND_STANDARDIZATION.md): 데이터 구조와 전처리 방향 원문
- [docs/legacy/3A_RAW_DATASET_LAYOUTS.md](3A_RAW_DATASET_LAYOUTS.md): 원본 데이터셋 배치와 로컬 레이아웃 원문
- [docs/legacy/4_MODEL_ARCHITECTURE.md](4_MODEL_ARCHITECTURE.md): 모델 구조 원문
- [docs/5_TARGETS_AND_LOSS.md](5_TARGETS_AND_LOSS.md): 타깃 인코딩과 loss 설계
- [docs/6_TRAINING_AND_EVALUATION.md](6_TRAINING_AND_EVALUATION.md): 학습/평가 정책
- [docs/legacy/18_ETRI_KCITY_CAMERA_TO_PV26_LABELS.md](18_ETRI_KCITY_CAMERA_TO_PV26_LABELS.md): ETRI KCity source 계약 원문
- [docs/legacy/19_LANE_VAL_OD_TEACHER_EVALSET.md](19_LANE_VAL_OD_TEACHER_EVALSET.md): lane-val OD pseudo eval 계약 원문
- [docs/legacy/20_SIGNAL_ATTR_TEACHER_PLAN.md](20_SIGNAL_ATTR_TEACHER_PLAN.md): traffic-light attr teacher 계약 원문
