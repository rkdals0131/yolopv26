...
EXPERIMENTS = {
    ...
    "stopline_axis_bin_endpoint_profile_head": {
        "freeze_policy": "lane_family_heads_only",
        "trunk_lr": 0.0,
        "head_lr": 1.0e-4,
        "loss_weights": {
    ...
    "lane_conditional_teacher_runtime_row": {
        "freeze_policy": "lane_conditional_row_only",
        "trunk_lr": 0.0,
        "head_lr": 5.0e-4,
        "loss_weights": {
        ...
        "overrides": {
            ...
            "lane_conditional_row_coordinate_mode": "seed_relative",
            "lane_conditional_row_max_delta_px": 160.0,
            "lane_conditional_row_enabled": False,
            "lane_conditional_row_merge_mode": "append",
            "lane_conditional_row_dense_gate_enabled": True,
            "lane_conditional_row_dense_min_mean_centerline": 0.35,
            "lane_conditional_row_dense_min_mean_support": 0.35,
    ...
    "lane_conditional_denoise_hardneg_row": {
        "freeze_policy": "lane_conditional_row_only",
        "trunk_lr": 0.0,
        "head_lr": 5.0e-4,
        "loss_weights": {
...
EXPERIMENTS["current_family_dense_seed_geometry_refine_vector_decoder"] = {
    **EXPERIMENTS["current_family_dense_seed_geometry_vector_decoder"],
    "train_defaults_overrides": {
        **EXPERIMENTS["current_family_dense_seed_geometry_vector_decoder"]["train_defaults_overrides"],
...
EXPERIMENTS["lane_family_det_source_distill_unlabeled_only"] = {
    **EXPERIMENTS["lane_family_det_source_distill_only"],
    "train_defaults_overrides": {
        **EXPERIMENTS["lane_family_det_source_distill_only"]["train_defaults_overrides"],
    ...
    **EXPERIMENTS["stopline_projection_comp_runtime"],
    ...
    "overrides": {
        **EXPERIMENTS["stopline_projection_comp_runtime"]["overrides"],
        "task_positive_task": "lane",
        "task_positive_fraction": 1.0,
        "lane_segfirst_track_mode": "row_scan_row_link",
