...
### bdd
- `tools/data_analysis/bdd/convert_bdd_pv26.py`: BDD100K -> PV26 변환
...
### etri
- `tools/data_analysis/etri/convert_etri_pv26.py`: ETRI(Mono+Multi) polygon JSON -> PV26 변환

### rlmd
- `tools/data_analysis/rlmd/convert_rlmd_pv26.py`: RLMD(1080p + AC labeled) -> PV26 변환

### wod
- `tools/data_analysis/wod/extract_wod_v2_sample.py`: Waymo v2 parquet 샘플 추출
- `tools/data_analysis/wod/convert_wod_pv26.py`: Waymo v2 parquet -> PV26 변환(minimal 우선)
