...
# =========================
APP_NAME             = os.getenv("PV26_MODAL_APP_NAME", "pv26-train-a10g")     # Modal app 이름 (보통 수정 불필요)
...
DEFAULT_EPOCHS       = 5        # 총 학습 epoch 수 (비용/시간에 거의 선형 비례)
DEFAULT_BATCH_SIZE   = 32        # 스텝당 배치 크기 (크면 GPU 사용률↑, 너무 크면 OOM)
